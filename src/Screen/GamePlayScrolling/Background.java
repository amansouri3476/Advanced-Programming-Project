...
//        g.drawImage(death_star, null, 1000, 250);
        ...
        if (!GameServer.isMultiplayer){
            if (!GameEventHandler.spaceship.isExploded){
                ...
                g.drawString(GameEventHandler.spaceship.x_coordinate + ", " + GameEventHandler.spaceship.y_coordinate, GameEventHandler.spaceship.x_coordinate, GameEventHandler.spaceship.y_coordinate);
            }
            else {
