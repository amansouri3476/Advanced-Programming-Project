...
public class BackgroundPanel extends JPanel {
     ...
     */
    public BackgroundPanel(Image image) throws IOException {
        this(image, SCALED);
    }
     ...
     */
    public BackgroundPanel(Image image, int style) throws IOException {
        setImage(image);
        setStyle(style);
     ...
     */
    public BackgroundPanel(Image image, int style, float alignmentX, float alignmentY) throws IOException {
        setImage(image);
        setStyle(style);
     ...
     */
    public BackgroundPanel(Paint painter) throws IOException {
        setPaint(painter);
        setLayout(new BorderLayout());
    }
